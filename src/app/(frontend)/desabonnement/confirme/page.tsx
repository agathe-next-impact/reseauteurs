        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          {ok ? (
            <>
              ...
              <h1 className="text-xl font-semibold text-text-dark mb-2">Désabonnement confirme</h1>
            ...
            <>
              ...
              <h1 className="text-xl font-semibold text-text-dark mb-2">Lien invalide</h1>
              <p className="text-sm text-text-light mb-6">
