...
export default async function DashboardPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <h1 className="text-xl font-bold text-[#16284f] mb-6">Tableau de bord</h1>

      {/* Rôle réseauteur */}
      {role === 'reseauteur' && (
        <div className="space-y-4">
          {!reseauteur ? (
            <div className="bg-white rounded-2xl border border-dashed border-[#e4e4e7] p-8 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white rounded-2xl border border-[#e4e4e7] p-5">
                ...
                <div className="mt-4">
                  <Link href="/dashboard/profil" className="text-sm text-[#2563EB] font-medium hover:text-[#1d4ed8] no-underline transition-colors flex items-center gap-1">
                    Modifier mon profil <ArrowRight size={12} aria-hidden />
                  </Link>
                </div>
              </div>
              <div className="bg-white rounded-2xl border border-[#e4e4e7] p-5">
          ...
          {!reseau ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white rounded-2xl border border-[#e4e4e7] p-5">
                ...
                <div className="mt-4">
                  <Link href="/dashboard/reseau" className="text-sm text-[#2563EB] font-medium hover:text-[#1d4ed8] no-underline transition-colors flex items-center gap-1">
                    Gérer mon réseau <ArrowRight size={12} aria-hidden />
                  </Link>
                </div>
              </div>
              <div className="bg-white rounded-2xl border border-[#e4e4e7] p-5">
                ...
                <div className="mt-4">
                  <Link href="/dashboard/reseau" className="text-sm text-[#2563EB] font-medium hover:text-[#1d4ed8] no-underline transition-colors flex items-center gap-1">
                    Gérer mes événements <ArrowRight size={12} aria-hidden />
                  </Link>
                </div>
                {!reseau.partenaire && (
                  <div className="mt-3">
                    <Link href="/dashboard/reseau" className="text-xs text-[#f5851f] font-medium hover:text-[#e07518] no-underline transition-colors">
