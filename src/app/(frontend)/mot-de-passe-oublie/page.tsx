      ...
      <div className="min-h-[calc(100vh-56px)] bg-gradient-to-br from-blue-50 to-white flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
            ...
            <h1 className="text-xl font-semibold text-text-dark mb-2">Email envoyé</h1>
    ...
    <div className="min-h-[calc(100vh-56px)] bg-gradient-to-br from-blue-50 to-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-text-light mt-1">Réinitialisation du mot de passe</p>
        </div>

        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          <h1 className="text-xl font-semibold text-text-dark mb-2">Mot de passe oublié ?</h1>
          <p className="text-sm text-text-light mb-6">
